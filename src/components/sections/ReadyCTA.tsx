  ...
  <section className="section-container">
    <div className="card glass flex flex-col gap-6 bg-slate-900/70 p-10 text-center md:flex-row md:items-center md:justify-between md:text-left">
      <div className="space-y-3">
        ...
        <h2 className="text-3xl font-semibold text-slate-50 md:text-4xl">Bring supervisor focus and builder energy to your team</h2>
        <p className="text-sm text-slate-300 md:max-w-xl">
          I help support, product, and operations leaders steady their queues, coach their people, and deploy automation that keeps customers confident.
        </p>
      </div>

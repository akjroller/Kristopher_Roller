  ...
  <section className="section-container">
    <div className="card glass flex flex-col gap-6 bg-slate-900/70 p-10 text-center md:flex-row md:items-center md:justify-between md:text-left">
      <div className="space-y-3">
        <p className="eyebrow mx-auto w-fit md:mx-0">Open to remote technical support & operations roles</p>
        ...
        <p className="text-sm text-slate-300 md:max-w-xl">
          I bring proven remote call center leadership, rapid troubleshooting, and documentation refresh skills. If you&apos;re seeking someone who can mentor peers while keeping AHT low, let&apos;s connect.
        </p>
      </div>
